...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fancyapps_fancybox_dist_jquery_fancybox_min_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fancyapps_fancybox_dist_jquery_fancybox_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__fancyapps_fancybox_dist_jquery_fancybox_min_js__);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_helpers__ = __webpack_require__(8);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  init: function init() {
    ...
    var jsHero = document.querySelector('.js-hero')
    var jsBackgrounds = document.querySelectorAll('.js-background')
    var jsPopup = document.querySelector('.js-popup')
    var galleryThumbs = document.querySelectorAll('.gallery-icon')

    // Handle external urls
    anchors.forEach(function (anchor) {
      if (Object(__WEBPACK_IMPORTED_MODULE_0__util_helpers__["c" /* isExternal */])(anchor)) {
    ...
    // Handle empty p tags
    paragraphs.forEach(__WEBPACK_IMPORTED_MODULE_0__util_helpers__["b" /* isEmpty */])
    ...
    if (window.matchMedia('(max-width: 1199px)').matches) {
      dropdowns.forEach(function (dropdown) {
        ...
        dropdown.addEventListener('click', __WEBPACK_IMPORTED_MODULE_0__util_helpers__["a" /* dropdownState */])
      })
    }

    // Handle hero background
    if (jsHero) {
      var mobileHero = jsHero.dataset.mobile
      var desktopHero = jsHero.dataset.desktop
    ...
    if (jsBackgrounds) {
      if (('IntersectionObserver' in window)) {
        var observer = new IntersectionObserver(__WEBPACK_IMPORTED_MODULE_0__util_helpers__["d" /* observeBackgrounds */]);

        jsBackgrounds.forEach(function (jsBackground) {
    ...
    if (galleryThumbs) {
      galleryThumbs.forEach(function (galleryThumb) {
        var galleryAnchor = galleryThumb.children[0]
    ...
    // Handle js popup
    if (jsPopup && !__WEBPACK_IMPORTED_MODULE_1_js_cookie__["get"]('popup')) {
      setTimeout(function () {
        $.fancybox.open({
          autoFocus: false,
          src: '.js-popup',
        ...
        __WEBPACK_IMPORTED_MODULE_1_js_cookie__["set"]('popup', 'true', { expires: 7 })
      }, 5000)
    }
...
/* unused harmony export disableContext */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return observeBackgrounds; });
/* unused harmony export handleBackground */
 ...
 */
var disableContext = function (element) {
  if (!element) { return }
 ...
 */
var observeBackgrounds = function (elements) {
 ...
 */
var handleBackground = function (element) {
  var mobileBG = element.target.dataset.mobile
  var desktopBG = element.target.dataset.desktop
 ...
 */
var dropdownState = function (event) {
  var currentDropdown = event.currentTarget
  var currentAnchor = event.target

  var parentAnchor = currentDropdown.children[0]
  var dropdowns = document.querySelectorAll('.menu-item-has-children')
